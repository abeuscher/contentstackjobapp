            ...
            <div className="home-delivery-section">
                ...
                <div className="left-pane">
                    ...
                    <input type="text" value={this.state.formHeader} onChange={this.changeText} />
                        ...
                        <label> Description
                    <textarea onChange={this.changeText} defaultValue={this.state.formCopy}></textarea>
                        </label>
                        <button onClick={this.publishText}>Publish</button>
                    </form>
                </div>
                ...
                <nav>
                    {this.props.tabs.map((tab, idx) => (
                        <button key={"hd-button-"+idx} onClick={this.swapTab} data-idx={idx}>{tab.section_label}</button>
                    ))}
                </nav>
            </div>
        )
