  ...
  return (
    <div className="home-silhouette">
      ...
      <div className="bg-images">
        ...
        <div className="profile-left silhouette" style={{ backgroundImage: "url('" + data.csHomepage.features_section.silhouette_left + "'" }}></div>
        <div className="profile-right silhouette" style={{ backgroundImage: "url('" + data.csHomepage.features_section.silhouette_right + "'" }}></div>
      </div>
