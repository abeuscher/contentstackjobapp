    ...
    <div className="home-silhouette">
      ...
      <div className="max-width">
        <div className="left-pane">
          ...
          <h2 className="small-header">{data.csHomepage.features_section.dev_section_header}</h2>
        ...
        <div className="right-pane">
          ...
          <h2 className="small-header">{data.csHomepage.features_section.business_section_header}</h2>
